...
namespace TopicWork
{
    public partial class CreateMember : Form
    {
        public CreateMember()
        {
            ...
            InitForm2();
            InitForm3();
			ContractpaycomboBox.Visible = false;
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            DateTime.TryParse(DateTextBox.Text, out DateTime result);
        ...
        private void ContractNamecomboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ContractpaycomboBox.Visible = true;
			label6.Visible = true;
		}
        ...
        private void ContractpaycomboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
